...
| 2026-09-13 | [2026-09-13-yue2-default-model.md](2026-09-13-yue2-default-model.md) | YuE2 as a second music model: session-scoped model choice asked once, `yue2` default, WSL runtime, `style.txt` artifact, CC BY-NC weight guardrail | active |
| 2026-09-14 | [2026-09-14-instrumental-generation-unsupported.md](2026-09-14-instrumental-generation-unsupported.md) | Correction: instrumental-only is unsupported by BOTH models (MiniMax Music 3 never delivered one either) — amends Y9; 0-byte lyrics stays as an attempt with a runtime warning; other `gen` families are leads | active |
| 2026-09-14 | [2026-09-14-yue2-score-first-workflow.md](2026-09-14-yue2-score-first-workflow.md) | YuE2 score-first workflow: `plan/v1` plans the ABC score in ≈19 s, the user approves/edits, then renders (≈43 s); plans are first-class artifacts; a take records the exact score bytes it rendered | active |
